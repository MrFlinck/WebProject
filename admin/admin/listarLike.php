...
<div class="col-sm-12">
    <nav aria-label="..." class="mb-3">
        <ul class="pagination justify-content-center">
            ...
            ?>
                <li class="page-item">
                    <a href="?p=admin/listarLike&letra=<?= $mostrar ?>" class="page-link">
                        <?= $mostrar ?>
                    </a>
                </li>
            <?php
        ...
        if ($dados) {
            foreach ($dados as $mostrar) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="?p=admin/salvar&id=<?= $mostrar['id'] ?>" class="btn btn-primary">
                            <i class="bi bi-pencil-square"></i>
                        
                        </a>
                        <a href="?p=admin/excluir&id=<?= $mostrar['id'] ?>" class="btn btn-danger"
